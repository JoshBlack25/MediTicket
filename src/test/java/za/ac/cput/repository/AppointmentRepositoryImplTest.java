/* AppointmentRepositoryImplTest.java
   Test class for AppointmentRepositoryImpl
...
public class AppointmentRepositoryImplTest {
    ...
    private static IAppointmentRepository repository;
    private static Appointment appointment1;
    private static Appointment appointment2;

    private static Doctor dummyDoctor;
    private static ClinicStaff dummyStaff;

    @BeforeAll
    static void setUp() throws Exception {
        // Reset singleton instance via reflection on the implementation class
        java.lang.reflect.Field field = AppointmentRepositoryImpl.class.getDeclaredField("repository");
        field.setAccessible(true);
        field.set(null, null);

        repository = AppointmentRepositoryImpl.getRepository();

        // Create dummy Doctor
        dummyDoctor = new Doctor.Builder()
                .setDoctorId(1)
                .setDoctorName("John")
                .setDoctorSurname("Smith")
                .setDoctorSpecialty("General Medicine")
                .setDoctorCell("0123456789")
                .setDoctorEmail("john.smith@hospital.com")
                .build();

        // Create dummy ClinicStaff
        dummyStaff = new ClinicStaff.Builder()
                .setStaffId(1)
                .setStaffName("Jane")
                .setStaffSurname("Doe")
                .setStaffRole("Receptionist")
                .setStaffEmail("jane.doe@hospital.com")
                .setStaffCell("0987654321")
                .build();
    ...
    void testSingleton_SameInstance() {
        AppointmentRepositoryImpl instance1 = AppointmentRepositoryImpl.getRepository();
        AppointmentRepositoryImpl instance2 = AppointmentRepositoryImpl.getRepository();
